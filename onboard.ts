...
`);
  ...
  // Basic info
  const userName = await question("What's your name? ");
  const agentName = await question("What would you like to name your AI companion? ");
...
💡 Pro Tip: The more you interact, the better your companion
   understands your preferences and adapts accordingly!
