...
description: Dynamic personality evolution for OpenClaw agents. Learn interaction patterns, adapt tone, and mode switching. USE WHEN: user wants to switch personas, generate new persona, analyze session patterns. DON'T USE WHEN: writing content (use content creation skills), coding (use coding skills), general task execution.
